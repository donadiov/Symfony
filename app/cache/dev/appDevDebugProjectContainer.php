...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.lineastelpolicia_connection' => 'getDoctrine_Dbal_LineastelpoliciaConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.default' => 'getDoctrine_Dbal_Logger_Profiling_DefaultService',
            'doctrine.dbal.logger.profiling.lineastelpolicia' => 'getDoctrine_Dbal_Logger_Profiling_LineastelpoliciaService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.default_manager_configurator' => 'getDoctrine_Orm_DefaultManagerConfiguratorService',
            'doctrine.orm.lineastelpolicia_entity_manager' => 'getDoctrine_Orm_LineastelpoliciaEntityManagerService',
            'doctrine.orm.lineastelpolicia_manager_configurator' => 'getDoctrine_Orm_LineastelpoliciaManagerConfiguratorService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/Victor-WEB/local/wamp/apps/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/Victor-WEB/local/wamp/apps/Symfony/app/Resources');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'lineastelpolicia' => 'doctrine.dbal.lineastelpolicia_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'lineastelpolicia' => 'doctrine.orm.lineastelpolicia_entity_manager'), 'default', 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'materiaweb', 'user' => 'root', 'password' => 'efldvl2102', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.dbal.lineastelpolicia_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return stdClass A stdClass instance.
     */
    protected function getDoctrine_Dbal_LineastelpoliciaConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.lineastelpolicia'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.lineastelpolicia_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'lineastelpolicia', 'user' => 'root', 'password' => 'efldvl2102', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Materiaweb\\MateriaBundle\\Resources\\config\\doctrine' => 'Materiaweb\\MateriaBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Materia\\SqlBundle\\Entity')), 'Materia\\SqlBundle\\Entity');
        $e->addDriver($d, 'Materiaweb\\MateriaBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('MateriaSqlBundle' => 'Materia\\SqlBundle\\Entity', 'MateriawebMateriaBundle' => 'Materiaweb\\MateriaBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'doctrine.orm.lineastelpolicia_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_LineastelpoliciaEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_lineastelpolicia_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_lineastelpolicia_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_lineastelpolicia_318965852a86d952df455682fd758d6aa52a0338e234b451e470f0a24dae4a3d');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\LineasTelefonicas\\Policia\\ERBundle\\Resources\\config\\doctrine' => 'LineasTelefonicas\\Policia\\ERBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'LineasTelefonicas\\Policia\\ERBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('LineasTelefonicasPoliciaERBundle' => 'LineasTelefonicas\\Policia\\ERBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        ...
        $this->services['doctrine.orm.lineastelpolicia_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.lineastelpolicia_connection'), $f);

        $this->get('doctrine.orm.lineastelpolicia_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.lineastelpolicia_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_LineastelpoliciaManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.lineastelpolicia_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/Victor-WEB/local/wamp/apps/Symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('lineastelpolicia', $this->get('doctrine.dbal.logger.profiling.lineastelpolicia'));

        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/Victor-WEB/local/wamp/apps/Symfony/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/Victor-WEB/local/wamp/apps/Symfony/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/Victor-WEB/local/wamp/apps/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Acme\\NewStoreBundle/Resources/views', 'AcmeNewStore');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Materiaweb\\MateriaBundle/Resources/views', 'MateriawebMateria');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Jazzyweb\\AulasMentor\\AlimentosBundle/Resources/views', 'JazzywebAulasMentorAlimentos');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Materia\\SqlBundle/Resources/views', 'MateriaSql');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\LineasTelefonicas\\Policia\\ERBundle/Resources/views', 'LineasTelefonicasPoliciaER');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/Victor-WEB/local/wamp/apps/Symfony/app/Resources/views');
        $instance->addPath('D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2110a033e3135935bb071032105709b5b1c');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.lineastelpolicia' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_LineastelpoliciaService()
    {
        return $this->services['doctrine.dbal.logger.profiling.lineastelpolicia'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev',
            'kernel.logs_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeNewStoreBundle' => 'Acme\\NewStoreBundle\\AcmeNewStoreBundle',
                'MateriawebMateriaBundle' => 'Materiaweb\\MateriaBundle\\MateriawebMateriaBundle',
                'JazzywebAulasMentorAlimentosBundle' => 'Jazzyweb\\AulasMentor\\AlimentosBundle\\JazzywebAulasMentorAlimentosBundle',
                'MateriaSqlBundle' => 'Materia\\SqlBundle\\MateriaSqlBundle',
                'LineasTelefonicasPoliciaERBundle' => 'LineasTelefonicas\\Policia\\ERBundle\\LineasTelefonicasPoliciaERBundle',
            ...
            'database_port' => '3306',
            'database_name' => 'materiaweb',
            'database_user' => 'root',
            'database_password' => 'efldvl2102',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => '2110a033e3135935bb071032105709b5b1c',
            'database_driver_poli' => 'pdo_mysql',
            'database_host_poli' => '127.0.0.1',
            'database_port_poli' => '3306',
            'database_name_poli' => 'lineastelpolicia',
            'database_user_poli' => 'root',
            'database_password_poli' => 'efldvl2102',
            ...
            'debug.container.dump' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '2110a033e3135935bb071032105709b5b1c',
            ...
            'session.save_path' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\Victor-WEB\\local\\wamp\\apps\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/../web',
            'assetic.write_to' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => 'C:\\CapacitacionJava\\Java\\jdk1.6.0_24\\bin\\java.EXE',
            ...
            'doctrine.entity_managers' => array(
                ...
                'lineastelpolicia' => 'doctrine.orm.lineastelpolicia_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'lineastelpolicia' => 'doctrine.dbal.lineastelpolicia_connection',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/dev/doctrine/orm/Proxies',
