    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/lineasTelefonicasPolicia')) {
            ...
            if (0 === strpos($pathinfo, '/lineasTelefonicasPolicia/l')) {
                ...
                if (0 === strpos($pathinfo, '/lineasTelefonicasPolicia/lista-usuarios')) {
                    ...
                    if ($pathinfo === '/lineasTelefonicasPolicia/lista-usuarios') {
                        return array (  '_controller' => 'LineasTelefonicas\\Policia\\ERBundle\\Controller\\UserController::listUserAction',  '_route' => 'lineas_telefonicas_policia_er_addUser',);
                    }
            ...
            if (rtrim($pathinfo, '/') === '/lineasTelefonicasPolicia') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'lineas_telefonicas_policia_er_listCompany');
                }

                return array (  '_controller' => 'LineasTelefonicas\\Policia\\ERBundle\\Controller\\DefaultController::indexAction',  '_route' => 'lineas_telefonicas_policia_er_listCompany',);
            }

            // lineas_telefonicas_policia_er_listPlanes
            if (rtrim($pathinfo, '/') === '/lineasTelefonicasPolicia') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'lineas_telefonicas_policia_er_listPlanes');
                }

                return array (  '_controller' => 'LineasTelefonicas\\Policia\\ERBundle\\Controller\\DefaultController::indexAction',  '_route' => 'lineas_telefonicas_policia_er_listPlanes',);
            }
