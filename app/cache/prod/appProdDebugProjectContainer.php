...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_66f9e4f7dc00ff0045180c9f71cd9145e2a094388e7a761599e1067580fe3e31');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_66f9e4f7dc00ff0045180c9f71cd9145e2a094388e7a761599e1067580fe3e31');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_66f9e4f7dc00ff0045180c9f71cd9145e2a094388e7a761599e1067580fe3e31');
        ...
        $f->setEntityNamespaces(array('MateriawebMateriaBundle' => 'Materiaweb\\MateriaBundle\\Entity', 'MateriaSqlBundle' => 'Materia\\SqlBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/Victor-WEB/local/wamp/apps/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/Victor-WEB/local/wamp/apps/Symfony/app/config/routing.yml', array('cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod',
            ...
            'debug.container.dump' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Victor-WEB/local/wamp/apps/Symfony/app/cache/prod/doctrine/orm/Proxies',
